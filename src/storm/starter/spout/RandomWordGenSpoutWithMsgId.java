...
public class RandomWordGenSpoutWithMsgId extends BaseRichSpout {
     ...
     * The program is a spout to generate a random word.
     * The random word is for word counting.
     * 
     * The program also writes back when the tuple ACK arrives.
     * 
     * FORMAT OF THE MsgId:
     * A string generated by you!
     * The length of the string can be specified.
     * 
     * PLS PAY ATTENTION TO THE CONSTRUCTION METHOD.
     */
    ...
    public RandomWordGenSpoutWithMsgId(int outputSize,
    		int idLength,
    		Boolean logEnable,
    		String emitSavePath,
    		String ackSavePath) {
    ...
    public RandomWordGenSpoutWithMsgId(){
...
//        _val = randString(outputSize);
    ...
    public void nextTuple() {
        ...
        msgId = randString(idLength);
        valueField = randString(outputSize);
    	collectorObj.emit(new Values(valueField, msgId), msgIdFleid);
        if (logEnable){
        	pwEmit.write("MsgIdField: " + 
        			String.valueOf(msgIdFleid) + 
        			" MsgId: " + 
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("item", "id"));
    }
